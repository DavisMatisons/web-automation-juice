...
public class PaymentShopPage extends DeliveryMethodPage{
  ...
  public static By CARD_NAME_FIELD = css("input[id='mat-input-10']");
  public static By CARD_NUMBER_FIELD = css("input[id='mat-input-11']");
  public static By EXPIRY_MONTH_FIELD = id("mat-input-12");
  public static By EXPIRY_YEAR_FIELD = text("Expiry Year");
  // Public methods
  // -------------------------------------------------------------------------------------------------------------------
